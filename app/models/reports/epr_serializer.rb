...
module Reports
  class EprSerializer < BaseSerializer
    ATTRIBUTES = {
      ...
      company_address_address_line1: "Address line 1",
      company_address_address_line2: "Address line 2",
      company_address_address_line3: "Address line 3",
      company_address_address_line4: "Address line 4",
