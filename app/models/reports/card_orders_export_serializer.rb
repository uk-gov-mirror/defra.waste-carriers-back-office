...
module Reports
  class CardOrdersExportSerializer < BaseSerializer
    ATTRIBUTES = {
      ...
      registered_address_line3: "Registered Address Line 3",
      registered_address_line4: "Registered Address Line 4",
      registered_address_line5: "Registered Address Line 5",
      registered_address_line6: "Registered Address Line 6",
      ...
      contact_address_line3: "Contact Address Line 3",
      contact_address_line4: "Contact Address Line 4",
      contact_address_line5: "Contact Address Line 5",
      contact_address_line6: "Contact Address Line 6",
