...
RSpec.describe "MissedCardPaymentForms" do
  ...
  describe "GET /bo/resources/:_id/payments/missed-card-payment" do
    context "when a valid user is signed in" do
      ...
      it "renders the new template, returns a 200 response and includes the reg identifier" do
        get "/bo/resources/#{transient_registration._id}/payments/missed-card-payment"
      ...
      context "when the resource is a registration" do
        ...
        it "renders the new template, returns a 200 response and includes the reg identifier" do
          get "/bo/resources/#{registration._id}/payments/missed-card-payment"
  ...
  describe "POST /bo/resources/:_id/payments/missed-card-payment" do
    let(:params) do
      {
    ...
    context "when a valid user is signed in" do
      ...
      it "renews the registration, redirects to the registration finance page, creates a new payment and assigns the correct updated_by_user to the payment" do
        ...
        post "/bo/resources/#{transient_registration._id}/payments/missed-card-payment", params: { missed_card_payment_form: params }
      ...
      context "when the resource is a registration" do
        it "redirects to the registration's finance details page, creates a new payment and assigns the correct updated_by_user to the payment" do
          ...
          post "/bo/resources/#{registration._id}/payments/missed-card-payment", params: { missed_card_payment_form: params }
