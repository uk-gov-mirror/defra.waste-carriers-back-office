...
module Reports
  RSpec.describe MonthlyFinanceReportSerializer do
    describe "#to_csv" do
      ...
      it "includes registration payment details" do
        expect(subject).to include(registration.finance_details.payments.first.amount.to_s)
        expect(subject).to include(registration.finance_details.orders.first.totalAmount.to_s)
      end
