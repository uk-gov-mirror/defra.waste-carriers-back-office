...
RSpec.describe "Whenever::Test::Shedule" do
  ...
  it "picks up the daily deactivate inactive users task run frequency and time" do
    job_details = schedule.jobs[:rake_and_format].find { |h| h[:task] == "deactivate_inactive_users" }
